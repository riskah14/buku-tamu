...
//apabila user yang mengakses sah
	...
	<body>
	<table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="grey">
		<tr>
	...
	<tr>
		<td width="200" valign="top" bgcolor="white" id="menu">
		<?php include "menu.php"; ?>
		</td>
   		<td align="left" valign="top" bgcolor="lightgrey" class="text" id="content"><?php include "konten.php"; ?></td>
    </tr>
    <tr>
